var init = function(){
		...
		if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
			...
			for (var i=0; i<textJson.formats.length; i++) {
				switch (parseInt(textJson.formats[i].format_id)) {
					case 18: table+='<tr><td><a href="'+textJson.formats[i].url+'">18- 640x360 MP4 H.264 96K</a></td></tr>'; break;
					case 22: table+='<tr><td><a href="'+textJson.formats[i].url+'">22- 720p MP4 H.264 192K</a></td></tr>'; break;
					case 37: table+='<tr><td><a href="'+textJson.formats[i].url+'">37- 1080p MP4 H.264 192K</a></td></tr>'; break;
					case 59: table+='<tr><td><a href="'+textJson.formats[i].url+'">59- 854x480 MP4 H.264 128K (id59)</a></td></tr>'; break;
					case 78: table+='<tr><td><a href="'+textJson.formats[i].url+'">78- 854x480 MP4 H.264 128K (id78)</a></td></tr>'; break;
	...
	xmlHttp.open("GET", "http://getrekt.ga/ytdl/getinfo.php?id="+id, true); // true for asynchronous 
	xmlHttp.send(null);
